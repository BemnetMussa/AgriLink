  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <button
        ...
        className="rounded-xl bg-green-600 px-12 py-3 font-bold text-white hover:bg-green-700 transition-all shadow-md shadow-green-100 active:scale-95 whitespace-nowrap"
      >
        Search
      </button>
